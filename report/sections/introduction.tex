...
In the second part, we investigate sim-to-real transfer on the PandaPush environment, first evaluating an on-policy approach with Proximal Policy Optimization (PPO) \cite{SchulmanPPO2017}
