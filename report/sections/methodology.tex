...
Training was performed for 70,000 episodes in order to allow the policy sufficient time to discover and
refine locomotion behaviours. The learning-rate decay thresholds and all other hyperparameters were selected empirically
based on preliminary training runs and were the ones that best balanced exploration, learning stability, and long-term performance.
