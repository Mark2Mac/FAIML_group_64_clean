...
To improve transfer across different dynamics, Domain Randomization (DR) was applied by varying the cube mass during training. \textbf{SAC explaination should be expanded, also maybe add some equations for the loss functions and the automatic entropy tuning mechanism.}
...
\textbf{Marco should finish the paragraph by explaining evaluation method and methodology for application on domain randomization}
