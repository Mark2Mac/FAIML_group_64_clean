...
After training, both PPO and SAC were evaluated on the target environment and compared, aiming to choose the best-performnig algorithm as the base on which to apply domain randomization.
